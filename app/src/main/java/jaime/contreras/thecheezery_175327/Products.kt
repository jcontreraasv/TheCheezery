...
class Products : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //    val type=bundle.getString("type")
            ...
            //when(type){
                ...
                //"hotDrinks"->cargarHotDrinks()
                //"sweets"->cargarSweets()
                //"salties"->cargarSalties()
            }
        //}
        //cargarColdDrinks()

        //var adapter=AdaptadorProductos(this,coldDrinks)
        //list_products.adapter=adapter

        //}


    //fun cargarColdDrinks(id:Int){
     private fun agregarProductos(id: Int)   {
        when(id){
            0->{
                coldDrinks.add(Product("Caramel Frap", R.drawable.caramelfrap, "Caramelsyrup meets coffee, milk and ice and whipped cream and buttery caramel sauce layer the love on top.", 5))
                coldDrinks.add(Product("Chocolate Frap", R.drawable.chocolatefrap, "Rich mocha-flavored sauce meets up with chocolaty chips, milk and ice for a blenderbash.", 6))
    ...
    private class AdaptadorProductos: BaseAdapter {
        ...
        override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
            ...
            var vista=inflator.inflate(R.layout.activity_item,null)
            ...
            vista.product_price.setText("$${produ.price.toString()}")
